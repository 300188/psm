			  ...
			  <div class="panel-body">
				<form id="userForm" role="form">
				  <div class="form-group">
					...
					<input type="text" class="form-control" value="${employee.name}" id="name" placeholder="请输入名称">
				  </div>
                    ...
                    success : function(msg) {
                        ...
                        if ( result.success ) {
                            ...
                            $.each(positions, function(i, position){
                                    ...
                                    tableContent += '  <option value="'+position.id+'" selected="selected">'+position.name+'</option>';
                                    }else{
